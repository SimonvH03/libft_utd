 ...
 *
 * This function allocates memory for a new element of a linked list,
 * 	and sets the content of the element to @p content.
 * The next pointer of the element is set to NULL.
 *
