 ...
 *
 * This function locates the first occurrence of the substring @p needle in the
 * string @p haystack, where not more than @p n characters are searched. Characters
